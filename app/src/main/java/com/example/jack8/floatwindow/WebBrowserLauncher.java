...
public class WebBrowserLauncher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT>=Build.VERSION_CODES.M&&!Settings.canDrawOverlays(WebBrowserLauncher.this))
            startActivityForResult(new Intent(Settings.ACTION_MANAGE_OVERLAY_PERMISSION,
                    Uri.parse("package:" + WebBrowserLauncher.this.getPackageName())), 1);
        else {
            startFloatWindow();
        }
    }
